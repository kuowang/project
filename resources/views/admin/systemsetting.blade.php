                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="username"  placeholder="请输入名称或注释" autocomplete="off" class="layui-input">
                                </div>
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加系统参数','{{ url("/add_system_list") }}',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
