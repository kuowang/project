                                    ...
                                    <tr>
                                        ...
                                        <td class="td-manage">
                                            @if( (in_array(20020301,$pageauth) && $val->budget_uid == $uid ) || in_array(200207,$manageauth))
                                                @if(!empty($val->offer_order_number))
                                                <a title="查看详情" class="btn btn-info"  href="/offer/offerCompletedDetail/{{ $val->engin_id }}/{{$val->programme_id}}">
                                                    <i class="layui-icon">详情</i>
                                                </a>
                                                <a title="导出"  target="_blank" class="btn btn-success"  href="/offer/offerCompletedDetail/{{ $val->engin_id }}/{{$val->programme_id}}?download=1" >
