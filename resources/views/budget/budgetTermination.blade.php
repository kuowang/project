                    ...
                    <div class="widget-header">
                        ...
                        <div class="dataTables_filter" id="data-table_filter" style="text-align: center;">
                            <label>
                                ...
                                @else
                                    <form class="form-search" action="/budget/budgetTermination" method="get">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-manage">
                                            @if( (in_array(20010401,$pageauth) && $val->budget_uid == $uid ) || in_array(200108,$manageauth))
                                                ...
                                                <a title="查看详情" class="btn btn-info"  href="/budget/budgetTerminationDetail/{{ $val->engin_id }}/{{ $val->programme_id }}">
                                                    <i class="layui-icon">详情</i>
                                                </a>
                                                <a title="导出" target="_blank"  class="btn btn-success"  target="_blank"  href="/budget/budgetTerminationDetail/{{ $val->engin_id }}/{{ $val->programme_id }}?download=1" >
