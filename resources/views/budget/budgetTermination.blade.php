                                    ...
                                    <tr>
                                        ...
                                        <td class="td-manage">
                                            @if( (in_array(20010401,$pageauth) && $val->budget_uid == $uid ) || in_array(200108,$manageauth))
                                                ...
                                                <a title="导出" target="_blank"  class="btn btn-success"  target="_blank"  href="/budget/budgetTerminationDetail/{{ $val->engin_id }}?download=1" onclick="return checkStatus({{$val->is_conf_architectural}})">
