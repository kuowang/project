                                    ...
                                    <tr>
                                        ...
                                        <td class="td-manage">
                                            @if( (in_array(20010301,$pageauth) && $val->budget_uid == $uid ) || in_array(200107,$manageauth))
                                                ...
                                                <a title="查看详情" class="btn btn-info"  href="/budget/budgetCompletedDetail/{{ $val->engin_id }}/{{ $val->programme_id }}">
                                                    <i class="layui-icon">详情</i>
                                                </a>
                                                <a title="导出"  target="_blank" class="btn btn-success"  target="_blank"  href="/budget/budgetCompletedDetail/{{ $val->engin_id }}/{{ $val->programme_id }}?download=1" onclick="return checkStatus({{$val->is_conf_architectural}})">
