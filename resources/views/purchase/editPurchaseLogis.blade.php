                        ...
                        <div id="dt_example" class="example_alt_pagination">
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tr>
                                    ...
                                    <td ><input name="vehicle_type"   value="{{$orderinfo->vehicle_type}}" class="span12"></td>
                                    <td class="pro-title">司机名称</td>
                                    <td ><input name="driver_name"  value="{{$orderinfo->driver_name}}" class="span12"></td>
                                    <td class="pro-title">身份证号</td>
                                    <td ><input name="shenfenzheng" value="{{$orderinfo->shenfenzheng}}" class="span12"></td>
                                    <td class="pro-title">车牌号码</td>
                                    <td ><input name="chepaihao"    value="{{$orderinfo->chepaihao}}" class="span12"></td>
                                </tr>
                                </tbody>
                            </table>
